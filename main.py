...
from PyQt6.QtGui import (
    QPixmap, QShortcut, QKeySequence, QAction
)
from PyQt6.QtWidgets import QMenu

from PyQt6.QtWidgets import (
    QApplication, QMainWindow, QFileDialog, QMessageBox,
    QTabWidget, QCompleter, QFileDialog
)
...
class MainApp(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.setWindowTitle("Pokeemerald-Expansion Editor")
...
""")
    ...
    def load_project(self, folder: str) -> None:
        ...
        self.setWindowTitle(f"Pokeemerald-Expansion Editor – {folder}")
